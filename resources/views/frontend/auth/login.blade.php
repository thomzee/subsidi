        ...
        <div class="col-xl-10 col-lg-12 col-md-9">
            ...
            <div class="card o-hidden border-0 shadow-lg my-5">
                <div class="card-body p-0">
                    ...
                    <div class="row">
                        <div class="col-lg-6 d-none d-lg-block" style="background-image: url('{{ asset(config('paths.assets').'login-bg.jpeg') }}');"></div>
                        <div class="col-lg-6">
                            <div class="p-5">
                                ...
                                <form method="POST" action="{{ route('login') }}" class="user">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="username" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="usernameHelp" placeholder="Enter Email...">
                                        @error('username')
...
{{--                                <div class="text-center">--}}
{{--                                    <a class="small" href="{{ asset(config('paths.theme').'forgot-password.html') }}">Forgot Password?</a>--}}
{{--                                </div>--}}
                            </div>
                        </div>
                    </div>
